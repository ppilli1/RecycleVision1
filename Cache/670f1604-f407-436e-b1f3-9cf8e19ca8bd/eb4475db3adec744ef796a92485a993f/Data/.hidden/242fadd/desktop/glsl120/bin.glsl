...
#endif
vec3 l9_42=mix(vec3(0.0,0.0,1.0),l9_33.xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_172=clamp(l9_169.w*2.0,0.0,1.0);
}
#else
{
float l9_173;
...
{
l9_173=clamp(dot(l9_169.xyz,vec3(l9_169.w)),0.0,1.0);
}
#else
{
float l9_174;
...
#if (sc_BlendMode_Multiply)
{
l9_175=(1.0-dot(l9_169.xyz,vec3(0.33333001)))*l9_169.w;
}
#else
{
float l9_176;
...
{
l9_176=(1.0-clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0))*l9_169.w;
}
#else
{
float l9_177;
#if (sc_BlendMode_ColoredGlass)
{
l9_177=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0)*l9_169.w;
}
#else
{
float l9_178;
#if (sc_BlendMode_Add)
{
l9_178=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_179;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_179=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0)*l9_169.w;
}
#else
{
float l9_180;
...
{
l9_180=dot(l9_169.xyz,vec3(0.33333001))*l9_169.w;
}
#else
{
float l9_181;
#if (sc_BlendMode_Min)
{
l9_181=1.0-clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_182;
#if (sc_BlendMode_Max)
{
l9_182=clamp(dot(l9_169.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_182=1.0;
...
#endif
l9_170=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_169.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_171);
}
#else
{
vec4 l9_183;
...
vec3 l9_186=mix(l9_185,definedBlend(l9_185,l9_169.xyz).xyz,vec3(l9_169.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_189=l9_169.w;
l9_188=vec4(mix(vec3(1.0),l9_169.xyz,vec3(l9_189)),l9_189);
}
#else
{
vec4 l9_190;
...
{
float l9_191=l9_169.w;
float l9_192;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_192=clamp(l9_191,0.0,1.0);
}
#else
{
l9_192=l9_191;
...
#endif
l9_190=vec4(l9_169.xyz*l9_192,l9_192);
}
#else
{
l9_190=l9_169;
...
{
l9_195=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_195=vec4(0.0);
...
vec4 l9_197=outputMotionVectorsIfNeeded(varPos,max(l9_196,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_199-0.0039215689)),min(1.0,l9_199+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_200=sc_ScreenCoordsGlobalToView(l9_4);
...
sc_writeFragData0(vec4(packValue(l9_201),packValue(l9_201),packValue(l9_201),packValue(l9_201)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_213=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
