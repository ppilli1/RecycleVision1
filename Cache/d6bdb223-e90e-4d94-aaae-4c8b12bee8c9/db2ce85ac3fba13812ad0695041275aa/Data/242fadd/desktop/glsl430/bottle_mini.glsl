...
#endif
vec3 l9_53=mix(vec3(0.0,0.0,1.0),l9_44.xyz,vec3(Port_Strength1_N200))+vec3(0.0,0.0,1.0);
...
#endif
sc_writeFragData0(max(l9_66,vec4(0.0)));
return;
}
vec4 l9_68;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_70=clamp(l9_65.w*2.0,0.0,1.0);
}
#else
{
float l9_71;
...
{
l9_71=clamp(dot(l9_65.xyz,vec3(l9_65.w)),0.0,1.0);
}
#else
{
float l9_72;
...
#if (sc_BlendMode_Multiply)
{
l9_73=(1.0-dot(l9_65.xyz,vec3(0.33333001)))*l9_65.w;
}
#else
{
float l9_74;
...
{
l9_74=(1.0-clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0))*l9_65.w;
}
#else
{
float l9_75;
#if (sc_BlendMode_ColoredGlass)
{
l9_75=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_65.w;
}
#else
{
float l9_76;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_77=clamp(dot(l9_65.xyz,vec3(1.0)),0.0,1.0)*l9_65.w;
}
#else
{
float l9_78;
...
{
l9_78=dot(l9_65.xyz,vec3(0.33333001))*l9_65.w;
}
#else
{
float l9_79;
...
{
vec3 l9_83=sc_GetFramebufferColor().xyz;
vec3 l9_84=mix(l9_83,definedBlend(l9_83,l9_65.xyz).xyz,vec3(l9_65.w));
...
{
float l9_87=l9_65.w;
l9_86=vec4(mix(vec3(1.0),l9_65.xyz,vec3(l9_87)),l9_87);
}
#else
{
vec4 l9_88;
...
#endif
l9_88=vec4(l9_65.xyz*l9_90,l9_90);
}
#else
{
l9_88=l9_65;
